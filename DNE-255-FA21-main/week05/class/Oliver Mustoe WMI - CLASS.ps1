...
# Post code to Github.
# Record screen while running your code using a screen recorder, like screencastify.
...
# I then used the Get-WMiObject cmdlet to call on a specific class, win32_networkadapterconfiguration, and filtered the index by 1 as it was my network adapters index number. I then piped that into the Select-Object cmdlet where I selected the information from $infoGrab.
